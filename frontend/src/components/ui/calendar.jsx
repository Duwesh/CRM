...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-zinc-950 text-zinc-50 rounded-md border border-zinc-800", className)}
      classNames={{
        ...
        day_selected:
          "bg-white text-black hover:bg-white hover:text-black focus:bg-white focus:text-black rounded-md font-bold",
